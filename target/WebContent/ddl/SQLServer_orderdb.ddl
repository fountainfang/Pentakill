...
INSERT INTO category(categoryName) VALUES ('Upright Vacuums');
INSERT INTO category(categoryName) VALUES ('Canister Vacuums');
INSERT INTO category(categoryName) VALUES ('Stick Vacuums');
INSERT INTO category(categoryName) VALUES ('Handheld Vacuums');
INSERT INTO category(categoryName) VALUES ('Robotic Vacuums');
INSERT INTO category(categoryName) VALUES ('Central Vacuum Systems');
INSERT INTO category(categoryName) VALUES ('Wet/Dry Vacuums');
INSERT INTO category(categoryName) VALUES ('Backpack Vacuums');

INSERT INTO product (productName, categoryId, productDesc, productPrice) 
VALUES 
    ('SharkNinja Upright Vacuum', 1, 'Weight:17.2', 349.00);

INSERT INTO product (productName, categoryId, productDesc, productPrice) 
VALUES 
    ('Bissell CleanView Bagless Vacuum', 1, 'Weight:16 lbs', 230.00);

INSERT INTO product (productName, categoryId, productDesc, productPrice) 
VALUES 
    ('Bissell Pet Hair Eraser Turbo Plus Vacuum', 2, 'Weight:13.75 lbs', 346.00);

INSERT INTO product (productName, categoryId, productDesc, productPrice) 
VALUES 
    ('Dyson V15 Detect Cordless Vacuum Cleaner', 2, 'Weight:6.8 lbs', 709.00);

INSERT INTO product (productName, categoryId, productDesc, productPrice) 
VALUES 
    ('Miele Boost CX1 Parquet', 2, 'Weight:18 lbs', 579.00);

INSERT INTO warehouse(warehouseName) VALUES ('Main warehouse');
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (1, 1, 5, 349);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (2, 1, 10, 230);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (3, 1, 3, 346);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (4, 1, 2, 709);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (5, 1, 6, 579);
